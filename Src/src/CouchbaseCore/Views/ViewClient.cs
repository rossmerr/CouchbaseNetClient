...
namespace Couchbase.Views
{
    ...
    internal class ViewClient : IViewClient
    {
        ...
        public ViewClient(HttpClient httpClient, IDataMapper mapper,  IBucketConfig bucketConfig, ClientConfiguration clientClientConfig, ILogger logger)
        {
        ...
        public async Task<IViewResult<T>> ExecuteAsync<T>(IViewQueryable query)
        {
            ...
            catch (AggregateException ae)
            {
                ae.Flatten().Handle(e =>
                {
                    ...
                    Log.LogError(uri.AbsoluteUri, e);
                    return true;
                });
            }
