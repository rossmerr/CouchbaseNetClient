    ...
    public abstract class ConnectionBase : IConnection
    {
        ...
        public void CountdownToClose(uint interval)
        {
            ...
            _timer = new Timer(state =>
            {
                ...
                {
                    Log.LogDebug("Restarting timer for connection for {0} after {1}ms", _identity, (DateTime.Now - startTime).TotalMilliseconds);
                ...
                else
                {
                    ...
                    Dispose();
                    Log.LogDebug("Disposing {0} after {1}ms", _identity, (DateTime.Now - startTime).TotalMilliseconds);
                }
            },
        ...
        {
            Log.LogDebug("Disposing the timer for {0}", _identity);
