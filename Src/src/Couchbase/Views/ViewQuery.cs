...
namespace Couchbase.Views
{
    ...
    public class ViewQuery : IViewQuery
    {
        ...
        public ViewQuery(ILogger logger)
            : this(null, DefaultHost, logger)
        {
        }

        public ViewQuery(string baseUri, ILogger logger)
            : this(null, baseUri, logger)
        {
        }

        public ViewQuery(string bucketName, string baseUri, ILogger logger)
            : this(bucketName, baseUri, null, logger)
        {
                _baseUri = new Uri(baseUri);
        }

        public ViewQuery(string bucketName, string designDoc, string viewName, ILogger logger)
        {
